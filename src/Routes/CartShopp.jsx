...
const CartShopp = () => {
  ...
  return (
    <div className='flex flex-col gap-2 py-20 items-center w-full bg-gray-100 sm:py-10'>
        ...
        <div className='flex justify-between w-3/4 mx-auto gap-10 sm:flex-col sm:w-11/12 '>
            ...
            console.log(e.target.value)}} id="methodPayment" className="mb-6 bg-gray-50 border w-1/3 sm:w-2/3 border-gray-300 text-gray-500 mt-4 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
