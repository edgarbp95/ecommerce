...
const Carrousel = () => {
  return (
    <div className={`bg relative bg-blackp flex items-center overflow-hidden`}>
      ...
      <ItemCarrousel imagen={auriculares} marca="Logitech" titulo="Gaming Headset G633" texto="Logitech G635 son unos auriculares inalámbricos con micrófono para gaming optimizados con la más avanzada tecnología de audio de Logitech. Los grandes transductores Pro-G de 50 mm y el sonido envolvente"/>
