...
const ItemCarouselMouse = ({dataIndex,image,name,clase,viewProduct,precio}) => {
  ...
  return (
    <>
      ...
      <Link onClick={scrollTop} to={`/${name}`}>
            <img
            className="py-5 rounded-t-lg h-56 img-card mx-auto sm:h-44 sm:py-2 md:h-48" 
            src={image}
            alt="product image"
            />
        </Link>
        <div className="px-5 pb-5">
            ...
            <span className="bg-orange-100 text-orange-600 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-600 ml-3">
                5.0
            </span>
            </div>
...
export default ItemCarouselMouse
